...
public class SwaggerApiConfig {
    public static final String SWAGGER_INFO_TITLE = "Book My Show";
    public static final String SWAGGER_INFO_DESCRIPTION = "This is BookMyShow API documentation";
    public static final String SWAGGER_INFO_VERSION = "1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME = "iamneo";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "kumar.raghuveer@iamneo.ai";
